...
| Env Var                           | Config                   | Description                                                                                                                                                                                                      | Default |
| --------------------------------- | ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| `LRSQL_ENABLE_ADMIN_MANAGEMENT`   | `enableAdminManagement`  | Whether or not to enable the admin management console, for deleting actors and downloading all statements as a CSV file.                                                                                         | `false` |
