...
| `LRSQL_ADMIN_LANGUAGE`          | `adminLanguage`         | Allows override of default language code (`en-US`). May require that you add new language map entries to `resources/customization/language.json`` to add a new language.                                       | `en-US`                                                                                     |
