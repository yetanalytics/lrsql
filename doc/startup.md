...
_NOTE:_ All attachments and documents have a maximum size of 1 megabyte in H2 (the maximum size of a [variable byte array](http://www.h2database.com/html/datatypes.html#binary_varying_type) in H2). As such, we strongly recommend using SQLite over H2 in production contexts.
