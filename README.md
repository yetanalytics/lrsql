...
| `LRSQL_AUTHORITY_TEMPLATE` | The filepath to the Statement authority template file, which describe how authorities are constructed during statement insertion. | `config/prod/template/authority.json.template`
