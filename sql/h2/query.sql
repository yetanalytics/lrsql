...
SELECT contents, state_id, last_modified FROM state_document
WHERE activity_iri = :activity-iri
...
SELECT contents, profile_id, last_modified FROM agent_profile_document
...
SELECT contents, profile_id, last_modified FROM activity_profile_document
WHERE activity_iri = :activity-iri
AND profile_id = :profile-id
